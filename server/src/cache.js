 ...
 */
function conversationsCacheKey(userId) {
  return `conv::${userId}`;
}
 ...
 */
function conversationsCachePrefix(userId) {
 ...
 */
function messagesCacheKey(conversationId, limit) {
 ...
 */
function messagesCachePrefix(conversationId) {
 ...
 */
function callHistoryCacheKey(userId, statusFilter, limit) {
 ...
 */
function callHistoryCachePrefix(userId) {
 ...
 */
async function readCached(state, key) {
 ...
 */
async function writeCached(state, key, value, ttlMs = DEFAULT_TTL_MS) {
 ...
 * @returns {Promise<void>}
 */
async function invalidateCache(state, ...prefixes) {
