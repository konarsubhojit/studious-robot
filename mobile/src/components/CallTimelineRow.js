 ...
 *
 * @param {{ direction?: string, status?: string, endReason?: string }} entry
 * @returns {boolean}
 */
 ...
 *
 * @param {{ direction?: string, status?: string, durationSeconds?: number | null }} entry
 * @returns {string}
 */
 ...
 *
 * @param {object} props
 * @param {Array<object>} props.entries - One or more call timeline entries, newest last.
 * @param {string} props.peerId
 * @param {(peerId: string) => void} [props.onCallBack]
 * @param {(peerId: string) => void} [props.onVideoCallBack]
 */
const CallTimelineRow = memo(function CallTimelineRow({
  entries,
  peerId,
  onCallBack,
  onVideoCallBack,
