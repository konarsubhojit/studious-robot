 ...
 */
export function emitEvent(level, name, data = {}) {
  const event = {
 ...
 * @returns {object} the emitted event
 */
export function emitMetric(metric, value = 1, data = {}) {
 ...
 * @param {object} [data]
 */
export function recordDegradation(source, message, data = {}) {
 ...
 */
export function getDegradations() {
