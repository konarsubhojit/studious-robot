...
/**
 * @typedef {'idle'|'outgoing_ringing'|'incoming_ringing'|'in_call'|'ended'} CallState
 */
...
/**
 * @typedef {'place'|'receive'|'connect'|'end'|'reset'} CallEvent
 */
 ...
 */
export function callStateReducer(state, event) {
 ...
 */
export function isRingingState(state) {
 ...
 */
export function isCallActiveState(state) {
